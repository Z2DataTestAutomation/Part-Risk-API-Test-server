...
public class GET_UpdatedPartDataWithinDateRange_TC016 extends config {
    ...
    public void _UpdatedPartDataWithinDateRange() {
        given().when().get(url + '/' + "/api/PartDataSearch/GetUpdatedPartDataWithinDateRange?Apikey=" + ViaSatAPIKey + "&fromDate=06-24-2020 01:00:00&toDate=06-24-2020 01:10:13&pagesize=10&currentpage=1")
