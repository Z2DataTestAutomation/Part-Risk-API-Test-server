...
public class GET_PartDataByPartId_PartConfig_TC004 extends config {
    ...
    @Test
    public void PartDataByPartId_PartConfig_1000078207() {
        given().when()
                .get(url + '/' + "/api/PartDataSearch/GetPartDataByPartId?PartId=1000078207&Apikey="
                        + API_Key)
                .then().assertThat().statusCode(200).and()
                .body("numFound", equalTo(1)).and()
                .body("results.partSummaryData.partID[0]" , equalTo(1000078207)).and()
